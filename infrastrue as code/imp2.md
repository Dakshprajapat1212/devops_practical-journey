 using input and op  filee are whrere we store things like varivbles that is  imp , search it , its half really requires  like from github and anywhere for  thing like security group etc  if ewe dont writ crreditionalin a tf
